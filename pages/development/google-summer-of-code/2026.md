...
We explicitly encourage applicants to use AI tools as much as they like (for brainstorming, code generation, refactoring, testing, documentation, and review). We believe this can significantly improve quality and learning when used thoughtfully. You remain fully responsible for the result: correctness, clean code, maintainability, and test quality. Please be prepared to explain and defend your design and tests (e.g., in a short video walkthrough) and do not use AI as a substitute for understanding. Also ensure that anything you submit is compatible with our license and contribution guidelines.
