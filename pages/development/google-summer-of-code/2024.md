...
> **Possible Mentors**: Julia Herold, Thorsten Bandel <br>
> **Difficulty level**: To Be Determined (tbd) 

The developer should have knowledge in Flutter and implement new features in Flutter that we already have in the Android native app.
