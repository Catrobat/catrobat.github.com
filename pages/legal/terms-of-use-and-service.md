...
6.  **Your Content and Conduct**
      <ol type="A">
         ...
         <li>
            For clarity, you retain all of your ownership rights in your Content. However, by submitting Content to Catrobat Services, you hereby put this Content under the licenses detailed on <a href="https://catrob.at/licensesofuploads">https://catrob.at/licensesofuploads</a>, thereby granting Catrobat and each user of the Software Applications and Services a worldwide, non-exclusive, royalty-free, sublicensable, and transferable license to use, reproduce, distribute, prepare derivative works of, display, and perform the Content in connection with the Service and Catrobat's (and its successors' and affiliates') activities, including without limitation for promoting and redistributing part or all of the Content (and derivative works thereof) in any media formats and through any media channels. The above licenses granted by you are perpetual and irrevocable.
         </li>
         <li>
